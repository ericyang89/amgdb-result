...
<?php		$this->contentContainerStart(); ?>
    <table class="table-condensed">
      ...
      <tr style="display:none" title="<?php printMLText("settings_theme_desc");?>">
      ...
      <tr style="display:none" title="<?php printMLText("settings_convertToPdf_desc");?>">
      ...
      <tr style="display:none" title="<?php printMLText("settings_viewOnlineFileTypes_desc");?>">
      ...
      <tr style="display:none" title="<?php printMLText("settings_enableConverting_desc");?>">
      ...
      <tr title="<?php printMLText("settings_stopWordsFile_desc");?>">
	    ...
	    <tr style="display:none" title="<?php printMLText("settings_enableClipboard_desc");?>">
      ...
      <tr style="display:none" title="<?php printMLText("settings_enableRecursiveCount_desc");?>">
      ...
      <tr style="display:none" title="<?php printMLText("settings_enableHelp_desc");?>">
      ...
      <tr style="display:none" title="<?php printMLText("settings_enableThemeSelector_desc");?>">
